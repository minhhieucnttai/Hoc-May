...
def main():
    ...
    data_paths = [
        base_path.parent / "project_TranMinhHieu" / "data" / "global_disaster_response_2018_2024.csv",
        base_path.parent / "project_TranMinhHieu" / "web" / "data" / "global_disaster_response_2018_2024.csv",
    ]
