# -*- coding: utf-8 -*-
"""
Script Huấn luyện Model XGBoost cho Web App
...
try:
    ...
    print("❌ XGBoost chưa cài! Cài đặt: pip install xgboost")
...
def train_xgboost_model(df):
    """Huấn luyện XGBoost Model - Deterministic"""
    print("\n" + "="*60)
    print("🚀 HUẤN LUYỆN XGBOOST MODEL (Deterministic)")
    print("="*60)
    
    if not XGBOOST_AVAILABLE:
        print("❌ XGBoost không sẵn có!")
    ...
    try:
        ...
        for col in categorical_features:
            if col in df_train.columns:
                ...
                available_features.remove(col)  # Loại bỏ categorical gốc
...
def main():
    """Hàm chính"""
    print("\n" + "="*60)
    print("📊 SCRIPT HUẤN LUYỆN XGBOOST MODEL (Deterministic)")
    print("="*60)
    ...
    # Train XGBoost
    model, scaler, metrics, features, encoders = train_xgboost_model(df)
    ...
    print("\n" + "="*60)
    print("✅ HOÀN TẤT! XGBoost Model đã sẵn sàng cho Web App")
    print("="*60 + "\n")
